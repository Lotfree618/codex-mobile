...
| [Accounts and Observability](tests/accounts-feedback-observability/index.md) | 12 | Account panels, quota refresh, Sentry, browser profiling, API perf logs, and Qodo diagnostic fixes. |
